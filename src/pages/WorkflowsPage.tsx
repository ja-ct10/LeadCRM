          ...
          <div className="bg-gray-50 dark:bg-[#030712] rounded-2xl border border-gray-300 dark:border-white/[0.1] w-full max-w-2xl overflow-hidden shadow-2xl">
            <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-white/[0.05]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Pre-configured automations for your industry.</p>
                </div>
              </div>
              <button onClick={() => setIsRecipesOpen(false)} className="p-2 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-gray-100 dark:bg-white/5 rounded-lg transition-colors"><X size={20} /></button>
            </div>
            ...
            <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4 max-h-[60vh] overflow-y-auto">
              {[
                ...
                <div key={idx} className="bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.05] rounded-xl p-5 hover:border-purple-500/50 transition-all group">
                  <div className="flex justify-between items-start mb-3">
                    <span className={`text-[10px] px-2 py-0.5 rounded-full border ${
                      recipe.category === 'Security' ? 'bg-red-500/10 text-red-400 border-red-500/20' :
                      recipe.category === 'Telecom' ? 'bg-blue-500/10 text-blue-400 border-blue-500/20' :
                      recipe.category === 'IT' ? 'bg-purple-500/10 text-purple-400 border-purple-500/20' :
                          ...
                          actions: [
                            {
                              ...
                              delayUnit: recipe.delayUnit as any || 'minutes',
                              config: {
                  ...
                  <h4 className="text-sm font-semibold text-slate-900 dark:text-white mb-1 group-hover:text-purple-400 transition-colors">{recipe.name}</h4>
            ...
            <div className="p-6 border-t border-gray-200 dark:border-white/[0.05] bg-gray-50 dark:bg-[#030712] flex justify-end">
              <button onClick={() => setIsRecipesOpen(false)} className="px-6 py-2 bg-gray-50 dark:bg-white/[0.05] text-slate-900 dark:text-white text-sm font-medium rounded-lg hover:bg-gray-200 dark:bg-white/10 transition-colors">Close</button>
            </div>
          </div>
        </div>
      )}
      ...
      {selectedWorkflowForLog && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-gray-50 dark:bg-[#030712] rounded-2xl border border-gray-300 dark:border-white/[0.1] w-full max-w-2xl overflow-hidden shadow-2xl">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                    {workflows.find(w => w.id === selectedWorkflowForLog)?.name}
                  </p>
                </div>
              </div>
              <button onClick={() => setSelectedWorkflowForLog(null)} className="p-2 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-gray-100 dark:bg-white/5 rounded-lg transition-colors"><X size={20} /></button>
            </div>
            
            <div className="p-6 max-h-[60vh] overflow-y-auto space-y-4">
              {workflowExecutions.filter(ex => ex.workflowId === selectedWorkflowForLog).length > 0 ? (
                workflowExecutions
                  .filter(ex => ex.workflowId === selectedWorkflowForLog)
                  .map(ex => (
                    <div key={ex.id} className="bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.05] rounded-xl p-4 hover:bg-gray-50 dark:hover:bg-white/[0.04] transition-colors">
                      <div className="flex justify-between items-start mb-2">
                        <div className="flex items-center gap-2">
                          <span className={`w-2 h-2 rounded-full ${ex.status === 'success' ? 'bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.6)]' : 'bg-red-500 shadow-[0_0_8px_rgba(239,68,68,0.6)]'}`}></span>
                          <span className="text-sm font-medium text-slate-900 dark:text-white">{ex.status === 'success' ? 'Executed Successfully' : 'Execution Failed'}</span>
                        </div>
            ...
            <div className="p-6 border-t border-gray-200 dark:border-white/[0.05] bg-gray-50 dark:bg-[#030712] flex justify-end">
              <button onClick={() => setSelectedWorkflowForLog(null)} className="px-6 py-2 bg-gray-50 dark:bg-white/[0.05] text-slate-900 dark:text-white text-sm font-medium rounded-lg hover:bg-gray-200 dark:bg-white/10 transition-colors">Close</button>
            </div>
          </div>
        </div>
      )}
