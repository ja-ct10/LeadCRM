  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { label: 'Monthly Recurring Revenue', value: '₱145,200', icon: TrendingUp, color: 'text-emerald-400' },
          ...
          { label: 'Overdue Payments', value: '₱8,500', icon: AlertCircle, color: 'text-red-400' },
        ].map((stat, i) => (
