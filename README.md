...
- **Recipe Templates**: Pre-configured workflow recipes for instant activation (e.g., _Stale Deal Escalation_, _New Lead Auto-Assignment_, _High-Value Deal Alert_).
