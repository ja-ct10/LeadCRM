...
| Stripe products/customers/refunds/subscriptions and billing database models | Retained for historical data and signed webhook dependencies. No portal billing/pricing APIs are registered. Destructive historical data cleanup is a separate operation. |
