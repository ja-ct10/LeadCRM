...
const ACTIVITY_COLORS: Record<ActivityType, string> = {
  ...
  stage_change:     'text-slate-500 bg-slate-100 dark:bg-white/[0.05]',
  'stage-change':   'text-slate-500 bg-slate-100 dark:bg-white/[0.05]',
  file_upload:      'text-slate-500 bg-slate-100 dark:bg-white/[0.05]',
  'file-upload':    'text-slate-500 bg-slate-100 dark:bg-white/[0.05]',
  deal_action:      'text-blue-500 bg-blue-50 dark:bg-blue-500/10',
