...
export default function EnvironmentsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Filters */}
      <div className="bg-white dark:bg-slate-950 rounded-xl border border-slate-200 dark:border-slate-800 p-4 flex flex-col md:flex-row gap-4">
...
const PALETTE: Record<ColorKey, { bg: string; border: string; label: string; icon: string; text: string }> = {
  slate:   { bg: 'bg-white dark:bg-slate-950', border: 'border-slate-200 dark:border-slate-800',   label: 'text-slate-500 dark:text-slate-400', icon: 'bg-slate-50 dark:bg-slate-800/50 text-slate-600 dark:text-slate-400', text: 'text-slate-900 dark:text-white' },
