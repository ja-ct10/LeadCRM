          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                className="h-9 w-9 flex items-center justify-center bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-semibold transition-all shadow-lg shadow-blue-500/20 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 cursor-pointer"
              >
                <Plus size={18} />
              </button>
            </TooltipTrigger>
            <TooltipContent>New Service Order</TooltipContent>
          </Tooltip>
        </TooltipProvider>
      </div>
