    ...
    <motion.div
      ...
      className={`p-4 rounded-xl border transition-all cursor-pointer group relative ${
        isDragging 
          ...
          : `${isRotting || isAging ? '' : 'bg-white dark:bg-white dark:bg-slate-950'} ${borderStyle} shadow-sm hover:shadow-md hover:-translate-y-0.5`
      }`}
    >
      <DealCardContent 
        deal={deal} 
    ...
    <div className="h-full flex flex-col space-y-6 relative overflow-hidden">
      ...
      {isManagePipelinesModalOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-gray-50 dark:bg-white dark:bg-slate-950 rounded-2xl border border-gray-300 dark:border-white/[0.1] w-full max-w-2xl overflow-hidden flex flex-col shadow-2xl max-h-[80vh]">
      ...
      {isPipelineModalOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-gray-50 dark:bg-white dark:bg-slate-950 rounded-2xl border border-gray-300 dark:border-white/[0.1] w-full max-w-md overflow-hidden flex flex-col shadow-2xl">
            <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-white/[0.05] shrink-0">
              <div>
            ...
            <div className="flex justify-end gap-3 p-6 border-t border-gray-200 dark:border-white/[0.05] shrink-0 bg-gray-50 dark:bg-white dark:bg-slate-950">
      ...
      <div className="flex flex-col gap-4 p-4 bg-white dark:bg-white dark:bg-slate-950/40 rounded-2xl border border-gray-200 dark:border-white/[0.05] shadow-sm">
            ...
            <div className="flex items-center gap-1.5 bg-slate-100 dark:bg-white/[0.02] p-1 rounded-xl border border-gray-200/50 dark:border-white/[0.05] w-fit">
              <button
                ...
                className={`flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-xs font-semibold transition-all ${
                  viewMode === 'kanban'
                    ? 'bg-white dark:bg-white dark:bg-slate-950 text-blue-500 dark:text-blue-400 shadow-sm border border-gray-255 dark:border-white/[0.05]'
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                  ...
                  {['all', 'open', 'won', 'lost'].map((st) => (
                    <button
                      ...
                      className={`py-1 rounded-lg text-[10px] font-bold uppercase tracking-wide transition-all ${
                        filterStatus === st
                          ? 'bg-white dark:bg-white dark:bg-slate-950 text-blue-500 dark:text-blue-400 shadow-sm border border-slate-200/40 dark:border-white/[0.05]'
              ...
              <div className="space-y-1">
                <div className="flex items-center justify-between">
                  ...
                  <select value={filterLocationOp} onChange={e => setFilterLocationOp(e.target.value)} className="bg-transparent border-none text-[10px] font-bold text-slate-400">
                    <option value="contains" className="bg-gray-100 dark:bg-white dark:bg-slate-950">Contains</option>
                    <option value="equals" className="bg-gray-100 dark:bg-white dark:bg-slate-950">Equals</option>
                    <option value="notequals" className="bg-gray-100 dark:bg-white dark:bg-slate-950">Not Equals</option>
                    <option value="starts" className="bg-gray-100 dark:bg-white dark:bg-slate-950">Starts With</option>
                    <option value="ends" className="bg-gray-100 dark:bg-white dark:bg-slate-950">Ends With</option>
                  </select>
                </div>
                <input
                  type="text"
              ...
              <div className="space-y-1">
                ...
                <select
                  ...
                  className="w-full bg-slate-50 dark:bg-white dark:bg-slate-950 border border-slate-200/50 dark:border-white/[0.05] rounded-xl px-2.5 py-1.5 text-xs text-slate-900 dark:text-white focus:outline-none"
                >
              ...
              <div className="space-y-1 col-span-1 md:col-span-2">
                <div className="flex items-center justify-between">
                  ...
                  <select value={filterDateCreatedOp} onChange={e => setFilterDateCreatedOp(e.target.value)} className="bg-transparent border-none text-[10px] font-bold text-slate-400">
                    <option value="any" className="bg-gray-100 dark:bg-white dark:bg-slate-950">Any Date</option>
                    <option value="equals" className="bg-gray-100 dark:bg-white dark:bg-slate-950">On Date</option>
                    <option value="before" className="bg-gray-100 dark:bg-white dark:bg-slate-950">Before Date</option>
                    <option value="after" className="bg-gray-100 dark:bg-white dark:bg-slate-950">After Date</option>
                    <option value="between" className="bg-gray-100 dark:bg-white dark:bg-slate-950">Between Dates</option>
                  </select>
                </div>
      ...
      {viewMode === 'kanban' && (
        ...
        >
          ...
          <DragOverlay dropAnimation={{
            ...
            {activeDeal ? (
              <div className="bg-white dark:bg-white dark:bg-slate-950 p-4 rounded-xl border border-blue-500/50 shadow-2xl flex flex-col gap-3 w-80 scale-105 rotate-2">
                <DealCardContent 
                  deal={activeDeal} 
      ...
      {viewMode === 'table' && (
        <div className="bg-white dark:bg-white dark:bg-slate-950/40 rounded-2xl border border-gray-200 dark:border-white/[0.05] overflow-hidden shadow-sm">
          ...
          {pipelineDeals.map((deal: any) => {
            ...
            return (
              <div
                key={deal.id}
                onClick={() => setSelectedDealId(deal.id)}
                className="group p-4 bg-white dark:bg-white dark:bg-slate-950/40 rounded-2xl border border-gray-200 dark:border-white/[0.05] shadow-sm hover:border-blue-500/30 transition-all cursor-pointer relative flex flex-col justify-between"
              >
                <div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-gray-50 dark:bg-white dark:bg-slate-950 rounded-2xl border border-gray-300 dark:border-white/[0.1] w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col shadow-2xl">
            <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-white/[0.05] shrink-0">
              <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <select value={newDeal.stageId} onChange={e => setNewDeal({...newDeal, stageId: e.target.value})} className="w-full bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.05] rounded-lg px-3 py-2 text-slate-900 dark:text-white focus:outline-none focus:border-gray-300 dark:border-white/[0.1] focus:bg-white/[0.04] transition-all">
                        {(activePipeline.stages as any[]).map((s: any) => <option key={s.id} value={s.id} className="bg-gray-50 dark:bg-white dark:bg-slate-950">{s.name}</option>)}
                      </select>
                    </div>
                    <div>
                      ...
                      <select value={newDeal.priority} onChange={e => setNewDeal({...newDeal, priority: e.target.value})} className="w-full bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.05] rounded-lg px-3 py-2 text-slate-900 dark:text-white focus:outline-none focus:border-gray-300 dark:border-white/[0.1] focus:bg-white/[0.04] transition-all">
                        <option className="bg-gray-50 dark:bg-white dark:bg-slate-950">Low</option><option className="bg-gray-50 dark:bg-white dark:bg-slate-950">Medium</option><option className="bg-gray-50 dark:bg-white dark:bg-slate-950">High</option>
                      </select>
                    </div>
                    <div>
                      ...
                      <select value={newDeal.assignedUserId} onChange={e => setNewDeal({...newDeal, assignedUserId: e.target.value})} className="w-full bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.05] rounded-lg px-3 py-2 text-slate-900 dark:text-white focus:outline-none focus:border-gray-300 dark:border-white/[0.1] focus:bg-white/[0.04] transition-all">
                        <option className="bg-gray-50 dark:bg-white dark:bg-slate-950" value="">Unassigned</option>
                        {users.filter(u => u.role === 'Sales Rep' || u.role === 'Client Admin').map(u => (
                          <option key={u.id} className="bg-gray-50 dark:bg-white dark:bg-slate-950" value={u.id}>{u.firstName} {u.lastName}</option>
                        ))}
                      </select>
                    </div>
                  </div>
                  ...
                  <div className="col-span-1 sm:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2 border-t border-slate-200/50 dark:border-white/[0.05]">
                    ...
                    <div>
                      ...
                      <select value={newDeal.customerType} onChange={e => setNewDeal({...newDeal, customerType: e.target.value})} className="w-full bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.05] rounded-lg px-3 py-2 text-slate-900 dark:text-white focus:outline-none focus:border-gray-300 dark:border-white/[0.1] focus:bg-white/[0.04] transition-all">
                        <option className="bg-gray-50 dark:bg-white dark:bg-slate-950">New Customer</option>
                        <option className="bg-gray-50 dark:bg-white dark:bg-slate-950">Existing Business</option>
                        <option className="bg-gray-50 dark:bg-white dark:bg-slate-950">Partner</option>
                      </select>
                    </div>
                    <div>
      ...
      {isLostReasonModalOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
          <motion.div 
            ...
            className="bg-gray-50 dark:bg-white dark:bg-slate-950 rounded-2xl border border-gray-300 dark:border-white/[0.1] w-full max-w-md shadow-2xl flex flex-col overflow-hidden"
          >
