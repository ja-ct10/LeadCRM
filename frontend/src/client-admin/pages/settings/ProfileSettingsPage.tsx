...
export default function ProfileSettingsPage({
  ...
  // Preferences states
  const [timezone, setTimezone] = useState("UTC-5 ΓÇö Eastern Time");
          ...
          <form onSubmit={handleSaveChanges} className="space-y-6">
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/[0.06] rounded-2xl p-6 shadow-xs space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  >
                    <option value="UTC-5 ΓÇö Eastern Time">
                      UTC-5 ΓÇö Eastern Time
                    </option>
                    <option value="UTC-8 ΓÇö Pacific Time">
                      UTC-8 ΓÇö Pacific Time
                    </option>
                    <option value="UTC+0 ΓÇö GMT / London">
                      UTC+0 ΓÇö GMT / London
                    </option>
                    <option value="UTC+8 ΓÇö Singapore / Manila">
                      UTC+8 ΓÇö Singapore / Manila
                    </option>
                  </select>
                </div>
                <div>
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/[0.06] rounded-2xl p-6 shadow-xs space-y-4">
              <div>
                ...
                <p className="text-xs text-slate-400 dark:text-slate-500 mt-0.5">
                  Read-only ΓÇö contact a system administrator to change
                </p>
              </div>
