...
// ΓöÇΓöÇΓöÇ Static chart data ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
export function CampaignReportView({
  ...
  const metricPanelText: Record<MetricTab, string> = {
    ...
    opened:    `${m.opened.toLocaleString()} individual contacts opened. Peak engagement occurred between 9:00 AM ΓÇô 11:30 AM.`,
