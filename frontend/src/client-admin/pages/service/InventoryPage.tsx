  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { label: 'Total Value', value: 'Γé▒1.2M', icon: DollarSign, color: 'text-emerald-400', trend: '+12%', trendUp: true },
                ...
                {filteredItems.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <span className="text-sm font-bold text-slate-900 dark:text-white">Γé▒{item.unitPrice.toLocaleString()}</span>
                      </td>
                      <td className="px-6 py-4">
              ...
              <div key={i} className="flex items-center justify-between p-3 rounded-xl bg-gray-50 dark:bg-white/[0.01] border border-white/[0.03]">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-slate-500">{log.action} ΓÇó {log.date}</p>
                  </div>
                </div>
