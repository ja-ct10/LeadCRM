    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-slate-800 hover:bg-gray-100 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-xl font-medium transition-all border border-slate-200 dark:border-slate-700 text-sm cursor-pointer"
        ...
        {canManageRoles && (
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-medium transition-all shadow-lg shadow-blue-500/20 text-sm cursor-pointer"
          >
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-3 text-xs font-medium text-slate-500 mb-6">
                ...
                <span className="text-slate-700">ΓÇó</span>
                <div className="flex items-center gap-1.5">
                            ...
                            return (
                              ...
                              >
                                <div>
                                  ...
                                  >
                                    {role.permissions.length} Privileges ΓÇó{" "}
              ...
              <div className="shrink-0 flex items-center gap-3">
                ...
                <div className="shrink-0">
                  <button
                    ...
                    className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-[#0A6EFF] hover:bg-blue-600 text-white px-5 py-2.5 rounded-xl text-sm font-semibold shadow-[0_4px_20px_rgba(10,110,255,0.25)] border border-blue-500/10 transition-all cursor-pointer"
                  >
                    <Plus size={16} />
                    <span>Add User</span>
                  </button>
