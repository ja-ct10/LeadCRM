---
inclusion: manual
description: Code review mode context for thorough quality and security assessment. Invoke with #review-mode.
---
...
- Is `tenantId` enforced on all data operations?
- Is RBAC checked before every create/edit/delete?
...
- **Critical**: Security vulnerabilities, data loss risks, RBAC bypass, cross-tenant access
- **High**: Bugs that break functionality, major performance issues, missing audit logs
